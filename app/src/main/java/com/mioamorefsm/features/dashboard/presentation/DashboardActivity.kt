package com.mioamorefsm.features.dashboard.presentation
...
import com.mioamorefsm.*
import com.mioamorefsm.ContactUtils.retrieveAllContacts
import com.mioamorefsm.R
import com.mioamorefsm.app.*
import com.mioamorefsm.app.NewFileUtils.browseDocuments
import com.mioamorefsm.app.NewFileUtils.getExtension
import com.mioamorefsm.app.domain.*
import com.mioamorefsm.app.types.DashboardType
import com.mioamorefsm.app.types.FragType
import com.mioamorefsm.app.types.TopBarConfig
import com.mioamorefsm.app.uiaction.DisplayAlert
import com.mioamorefsm.app.utils.*
import com.mioamorefsm.app.utils.AppUtils.Companion.isProfile
...
import com.mioamorefsm.features.NewQuotation.AddQuotFormFragment
import com.mioamorefsm.features.NewQuotation.ViewAllQuotListFragment
import com.mioamorefsm.features.NewQuotation.ViewDetailsQuotFragment
import com.mioamorefsm.features.SearchLocation.SearchLocationFragment
import com.mioamorefsm.features.SearchLocation.locationInfoModel
import com.mioamorefsm.features.TA.ViewAllTAListFragment
import com.mioamorefsm.features.achievement.AchievementFragment
import com.mioamorefsm.features.activities.presentation.*
import com.mioamorefsm.features.addAttendence.*
import com.mioamorefsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.mioamorefsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.mioamorefsm.features.addAttendence.model.GetReportToFCMResponse
import com.mioamorefsm.features.addAttendence.model.GetReportToResponse
import com.mioamorefsm.features.addAttendence.model.Leave_list_Response
import com.mioamorefsm.features.addorder.presentation.AddOrderFragment
import com.mioamorefsm.features.addshop.model.AddShopRequestData
import com.mioamorefsm.features.addshop.model.AddShopResponse
import com.mioamorefsm.features.addshop.presentation.AddShopFragment
import com.mioamorefsm.features.addshop.presentation.OTPVerificationDialog
import com.mioamorefsm.features.addshop.presentation.ScanImageFragment
import com.mioamorefsm.features.addshop.presentation.ShowCardDetailsDialog
import com.mioamorefsm.features.alarm.model.AlarmData
import com.mioamorefsm.features.alarm.presetation.AttendanceReportFragment
import com.mioamorefsm.features.alarm.presetation.PerformanceReportFragment
import com.mioamorefsm.features.alarm.presetation.VisitReportDetailsFragment
import com.mioamorefsm.features.alarm.presetation.VisitReportFragment
import com.mioamorefsm.features.attendance.AttendanceFragment
import com.mioamorefsm.features.attendance.api.AttendanceRepositoryProvider
...
import com.mioamorefsm.features.averageshop.presentation.AverageShopFragment
import com.mioamorefsm.features.avgorder.presentation.AverageOrderFragment
import com.mioamorefsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.mioamorefsm.features.beatCustom.TeamBeatListFragment
import com.mioamorefsm.features.billing.presentation.AddBillingFragment
import com.mioamorefsm.features.billing.presentation.BillingDetailsFragment
import com.mioamorefsm.features.billing.presentation.BillingListFragment
import com.mioamorefsm.features.changepassword.presentation.ChangePasswordDialog
import com.mioamorefsm.features.chat.model.ChatListDataModel
import com.mioamorefsm.features.chat.model.ChatUserDataModel
import com.mioamorefsm.features.chat.model.GroupUserDataModel
import com.mioamorefsm.features.chat.presentation.*
import com.mioamorefsm.features.chatbot.presentation.ChatBotFragment
import com.mioamorefsm.features.chatbot.presentation.ChatBotShopListFragment
import com.mioamorefsm.features.chatbot.presentation.ReportsFragment
import com.mioamorefsm.features.chatbot.presentation.SelectLanguageDialog
import com.mioamorefsm.features.commondialog.presentation.CommonDialog
import com.mioamorefsm.features.commondialog.presentation.CommonDialogClickListener
import com.mioamorefsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.mioamorefsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.mioamorefsm.features.commondialogsinglebtn.OnDialogClickListener
import com.mioamorefsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.mioamorefsm.features.dailyPlan.prsentation.AllShopListFragment
import com.mioamorefsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.mioamorefsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.mioamorefsm.features.damageProduct.ShopDamageProductListFrag
import com.mioamorefsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.mioamorefsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.mioamorefsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.mioamorefsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.mioamorefsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.mioamorefsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.mioamorefsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.mioamorefsm.features.dashboard.presentation.model.ContentListResponseModel
import com.mioamorefsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.mioamorefsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.mioamorefsm.features.device_info.presentation.DeviceInfoListFragment
import com.mioamorefsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.mioamorefsm.features.document.DocumentRepoFeatureNewFragment
import com.mioamorefsm.features.document.presentation.DocumentListFragment
import com.mioamorefsm.features.document.presentation.DocumentTypeListFragment
import com.mioamorefsm.features.document.presentation.OpenFileWebViewFragment
import com.mioamorefsm.features.dymanicSection.presentation.AddDynamicFragment
import com.mioamorefsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.mioamorefsm.features.dymanicSection.presentation.DynamicListFragment
import com.mioamorefsm.features.dymanicSection.presentation.EditDynamicFragment
import com.mioamorefsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.mioamorefsm.features.home.presentation.HomeFragment
import com.mioamorefsm.features.homelocation.presentation.HomeLocationFragment
import com.mioamorefsm.features.homelocation.presentation.HomeLocationMapFragment
import com.mioamorefsm.features.know_your_state.KnowYourStateFragment
import com.mioamorefsm.features.lead.LeadFrag
import com.mioamorefsm.features.lead.ViewLeadFrag
import com.mioamorefsm.features.leaveapplynew.LeaveHome
import com.mioamorefsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.mioamorefsm.features.localshops.LocalShopListFragment
import com.mioamorefsm.features.localshops.LocalShopListMapFragment
import com.mioamorefsm.features.localshops.NearByShopsMapFragment
import com.mioamorefsm.features.location.*
import com.mioamorefsm.features.login.ShopFeedbackEntity
import com.mioamorefsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.mioamorefsm.features.login.presentation.LoginActivity
import com.mioamorefsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.mioamorefsm.features.logoutsync.presentation.LogoutSyncFragment
import com.mioamorefsm.features.marketing.presentation.MarketingPagerFragment
import com.mioamorefsm.features.meetinglist.prsentation.MeetingListFragment
import com.mioamorefsm.features.member.MapViewForTeamFrag
import com.mioamorefsm.features.member.model.TeamLocDataModel
import com.mioamorefsm.features.member.model.TeamShopListDataModel
import com.mioamorefsm.features.member.presentation.*
import com.mioamorefsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.mioamorefsm.features.micro_learning.presentation.MicroLearningListFragment
import com.mioamorefsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.mioamorefsm.features.myallowancerequest.MyallowanceRequestFragment
import com.mioamorefsm.features.myjobs.model.CustomerDataModel
import com.mioamorefsm.features.myjobs.presentation.*
import com.mioamorefsm.features.myorder.presentation.MyOrderListFragment
import com.mioamorefsm.features.myprofile.presentation.MyProfileFragment
import com.mioamorefsm.features.nearbyshops.presentation.BeatListFragment
import com.mioamorefsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.mioamorefsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.mioamorefsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.mioamorefsm.features.newcollection.CollectionDetailsStatusFragment
import com.mioamorefsm.features.newcollection.CollectionShopListFragment
import com.mioamorefsm.features.newcollection.NewCollectionListFragment
import com.mioamorefsm.features.newcollectionreport.*
import com.mioamorefsm.features.notification.NotificationFragment
import com.mioamorefsm.features.orderList.NewDateWiseOrderListFragment
import com.mioamorefsm.features.orderList.NewOrderListFragment
import com.mioamorefsm.features.orderList.OrderListFragment
import com.mioamorefsm.features.orderdetail.presentation.OrderDetailFragment
import com.mioamorefsm.features.orderhistory.ActivityMapFragment
import com.mioamorefsm.features.orderhistory.OrderhistoryFragment
import com.mioamorefsm.features.orderhistory.TimeLineFragment
import com.mioamorefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.mioamorefsm.features.orderhistory.model.FetchLocationRequest
import com.mioamorefsm.features.orderhistory.model.FetchLocationResponse
import com.mioamorefsm.features.orderhistory.model.LocationData
import com.mioamorefsm.features.performance.GpsStatusFragment
import com.mioamorefsm.features.performance.PerformanceFragment
import com.mioamorefsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.mioamorefsm.features.performance.model.UpdateGpsInputParamsModel
import com.mioamorefsm.features.permissionList.ViewPermissionFragment
import com.mioamorefsm.features.photoReg.PhotoAttendanceFragment
import com.mioamorefsm.features.photoReg.ProtoRegistrationFragment
import com.mioamorefsm.features.photoReg.RegisTerFaceFragment
import com.mioamorefsm.features.photoReg.TeamAttendanceFragment
import com.mioamorefsm.features.quotation.presentation.*
import com.mioamorefsm.features.reimbursement.presentation.EditReimbursementFragment
import com.mioamorefsm.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.mioamorefsm.features.reimbursement.presentation.ReimbursementFragment
import com.mioamorefsm.features.reimbursement.presentation.ReimbursementListFragment
import com.mioamorefsm.features.report.presentation.*
import com.mioamorefsm.features.returnsOrder.*
import com.mioamorefsm.features.settings.presentation.SettingsFragment
import com.mioamorefsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.mioamorefsm.features.shopdetail.presentation.*
import com.mioamorefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.mioamorefsm.features.stock.StockDetailsFragment
import com.mioamorefsm.features.stock.StockListFragment
import com.mioamorefsm.features.stockAddCurrentStock.AddShopStockFragment
import com.mioamorefsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.mioamorefsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.mioamorefsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.mioamorefsm.features.stockCompetetorStock.CompetetorStockFragment
import com.mioamorefsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.mioamorefsm.features.survey.SurveyFrag
import com.mioamorefsm.features.survey.SurveyViewDtlsFrag
import com.mioamorefsm.features.survey.SurveyViewFrag
import com.mioamorefsm.features.task.presentation.AddTaskFragment
import com.mioamorefsm.features.task.presentation.CalenderTaskFragment
import com.mioamorefsm.features.task.presentation.EditTaskFragment
import com.mioamorefsm.features.task.presentation.TaskListFragment
import com.mioamorefsm.features.timesheet.presentation.AddTimeSheetFragment
import com.mioamorefsm.features.timesheet.presentation.EditTimeSheetFragment
import com.mioamorefsm.features.timesheet.presentation.TimeSheetListFragment
import com.mioamorefsm.features.viewAllOrder.CartFragment
import com.mioamorefsm.features.viewAllOrder.OrderTypeListFragment
import com.mioamorefsm.features.viewAllOrder.ViewAllOrderListFragment
import com.mioamorefsm.features.viewAllOrder.ViewCartFragment
import com.mioamorefsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.mioamorefsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.mioamorefsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.mioamorefsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.mioamorefsm.features.viewPPDDStock.ViewOutstandingFragment
import com.mioamorefsm.features.viewPPDDStock.ViewPPDDListFragment
import com.mioamorefsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.mioamorefsm.features.viewPPDDStock.ViewStockFragment
import com.mioamorefsm.features.weather.presentation.WeatherFragment
import com.mioamorefsm.mappackage.MapActivity
import com.mioamorefsm.mappackage.MapActivityWithoutPath
import com.mioamorefsm.mappackage.SendBrod
import com.mioamorefsm.widgets.AppCustomEditText
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xmioamorefsmlogsample/log").path);
            //27-09-2021
            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmioamorefsmlogsample/log").path);
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmioamorefsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmioamorefsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmioamorefsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmioamorefsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
