package com.mioamorefsm.features.logoutsync.presentation
...
import com.mioamorefsm.app.AppDatabase
...
import com.mioamorefsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.mioamorefsm.features.addshop.api.AddShopRepositoryProvider
import com.mioamorefsm.features.billing.api.AddBillingRepoProvider
import com.mioamorefsm.features.billing.model.AddBillingInputParamsModel
...
import com.mioamorefsm.features.dashboard.presentation.ReasonDialog
...
import com.mioamorefsm.features.document.model.AddEditDocumentInputParams
import com.mioamorefsm.features.document.model.DocumentAttachmentModel
...
import com.mioamorefsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.mioamorefsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
...
import com.mioamorefsm.features.orderhistory.model.*
...
import com.mioamorefsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.mioamorefsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.mioamorefsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.mioamorefsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.mioamorefsm.features.timesheet.model.AddTimeSheetInputModel
import com.mioamorefsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.mioamorefsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.mioamorefsm.features.viewAllOrder.model.AddOrderInputProductList
import com.mioamorefsm.mappackage.SendBrod
import com.mioamorefsm.widgets.AppCustomTextView
import com.mioamorefsm.MonitorService
import com.mioamorefsm.features.addshop.model.*
import com.mioamorefsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.mioamorefsm.features.login.api.LoginRepositoryProvider
import com.mioamorefsm.features.login.model.GetConcurrentUserResponse
import com.mioamorefsm.features.returnsOrder.ReturnProductList
import com.mioamorefsm.features.returnsOrder.ReturnRequest
import com.mioamorefsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmioamorefsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmioamorefsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmioamorefsmlogsample/log.zip").path);
